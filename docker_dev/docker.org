...
** Generic database image
   ...
   #+BEGIN_SRC sh :tangle ../docker/generic_db_container/Dockerfile
     FROM postgres:9.3
   #+END_SRC

   #+BEGIN_SRC sh :tangle ../docker/generic_db_container/000_fix-acl.sh :shebang "#!/bin/bash"
   ...
   #+BEGIN_SRC sh :tangle ../docker/generic_db_container/010_create_user_db.sh :shebang "#!/bin/bash"
   ...
   #+BEGIN_SRC sh :tangle ../docker/generic_db_container/Makefile
build:
...
prepare:
	git archive --format tar.gz --output latest_Tbro.tar.gz latest ../../
   #+END_SRC
...
prepare:
	git archive --format tar.gz --output latest_worker-unix.tar.gz latest ../../src/queue/worker-php/
   #+END_SRC
...
prepare:
	git archive --format tar.gz --output latest_demo-set.tar.gz latest ../../doc/tutorial/cannabis_sativa_demo
   #+END_SRC
