...
RUN a2enmod rewrite
   ...
   #+BEGIN_SRC makefile :tangle ../docker/apache_container/Makefile
prepare:
	git clone https://github.com/TBroTeam/TBro latest_Tbro
	tar -czf $$PWD/latest_Tbro.tar.gz latest_Tbro
   #+END_SRC
...
CMD export PGPASSWORD="$CHADO_ENV_DB_PW"; \
   ...
   #+BEGIN_SRC makefile :tangle ../docker/generic_chado_db_reload_container/Makefile
prepare:
...
RUN apt-get --assume-yes install \
   ...
   #+BEGIN_SRC makefile :tangle ../docker/worker_container/Makefile
prepare:
...
FROM tbro_apache
   ...
   #+BEGIN_SRC makefile :tangle ../docker/demo_container/Makefile
prepare:
	git clone https://github.com/TBroTeam/DemoData
	tar czf $$PWD/latest_demo-set.tar.gz DemoData/cannabis_sativa_demo
   #+END_SRC
...
CMD export FTP_USER=${FTP_USER:-ftpuser}; export FTP_PW=${FTP_PW:-ftppassword}; adduser "$FTP_USER"; echo "$FTP_USER":"$FTP_PW" | chpasswd; while true; do vsftpd; done
   ...
   Creation of the image:
   #+BEGIN_SRC makefile :tangle ../docker/worker_ftp_container/Makefile
prepare:
