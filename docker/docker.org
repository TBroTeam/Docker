...
** Load chado database image
   ...
   #+BEGIN_SRC sh :tangle generic_chado_db_reload_container/Dockerfile
     ...
     CMD export PGPASSWORD="$CHADO_ENV_DB_PW"; \
         cat /tmp/2014-11-24_chado_database_complete_GO1.2.sql | pgsql --host=$CHADO_PORT_5432_TCP_ADDR --port=$CHADO_PORT_5432_TCP_PORT --username=$CHADO_ENV_DB_USER $CHADO_ENV_DB_NAME
