...
** Setup procedure
   ...
   #+BEGIN_SRC sh :results output silent :dir /sudo::/tmp/tbro_docker/
     ...
     docker run -d -e DB_NAME=chado -e DB_USER=tbro -e DB_PW=tbro --name "Chado_DB_4_TBro" generic_chado_db_reload
...
** Load chado database image
   ...
   #+BEGIN_SRC sh :tangle ./generic_chado_db_reload_container/020_import_chado_db.sh :shebang "#!/bin/bash"
     ...
     cat /tmp/2014-11-24_chado_database_complete_GO1.2.sql | psql -h localhost -U $DB_USER $DB_NAME
