...
** Setup procedure
   ...
   #+BEGIN_SRC sh :dir /sudo::
     ...
     docker rmi tbro_demo tbro_worker_ftp tbro_worker tbro_chado_generate tbro_apache greatfireball/generic_postgres_db  tbro_generic_chado_generate
   #+END_SRC
...
** Preparation
   ...
   #+BEGIN_SRC sh :results output silent
     for DIRECTORY in apache_container worker_container chado_create_container generic_db_container demo_container worker_ftp_container generic_chado_create_container
     do
         if [ -e "$DIRECTORY" ]
         then
             rm -rf "$DIRECTORY"
...
** Installation of generic Chado database
   ...
   #+BEGIN_SRC sh :tangle generic_chado_create_container/Dockerfile
     CMD export HOME=/tmp/; \
         ...
         export PGPASSWORD="$CHADO_ENV_DB_PW"; \
         $HOME/generate_db.sh
         pg_dump --dbname=$CHADO_ENV_DB_NAME --host=$CHADO_PORT_5432_TCP_ADDR --port=$CHADO_PORT_5432_TCP_PORT --username=$CHADO_ENV_DB_USER | pbzip2 -9 --verbose --stdout --compress > /tmp/generic_chado_1.23.sql
   #+END_SRC
